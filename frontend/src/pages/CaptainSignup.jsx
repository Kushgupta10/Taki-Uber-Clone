...
const Captainsignup = () => {
  ...
  return (
     <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        <img src={driver} className='w-16 mb-10  '/>
      ...
      <form onSubmit={(e) => {
        ...
        <button  
        className='bg-[#111] text-white  font-semibold  px-4 py-2 text-lg placeholder:text-base rounded w-full mb-2'>Create Captain Account</button>

      </form>
      <p className='text-center'>Already have an account? <Link to='/captain-login' className='text-blue-500 cursor-pointer'>Login here</Link></p>
