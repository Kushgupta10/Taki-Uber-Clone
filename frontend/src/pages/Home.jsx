...
import ConfirmRide from '../components/ComfirmRide';
...
useGSAP( function() {
  ...
  return (
    <div className='relative h-screen overflow-hidden'>
      <img src={logoBlack} alt="logo" className='w-16 absolute left-5 top-5 ' />
      ...
      <div className=' flex flex-col justify-end h-screen absolute top-0 w-full '>
        <div className='h-[30%] p-6 bg-white relative'>
          <h5 ref={panelCloseRef} onClick={() => {
            setPanelOpen(false)}}
           className='absolute opacity-0 top-5 right-5 text-2xl  cursor-pointer'>
