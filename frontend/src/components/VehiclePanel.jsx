    ...
    <div className='mb-10'>
        ...
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
          ...
          className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
            ...
            <h2 className='font-semibold text-lg'>Rs{props.fare.car}</h2>
          </div>
          <div onClick={()=>{
            props.setConfirmRidePanel(true)
          ...
          className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
            ...
            <h2 className='font-semibold text-lg'>Rs{props.fare.moto}</h2>
          </div>
           <div onClick={()=>{
            props.setConfirmRidePanel(true)
           ...
           className='flex border-2 active:border-black mb-2 rounded-xl w-full p-3 items-center justify-between'>
            ...
            <h2 className='font-semibold text-lg'>Rs{props.fare.auto}</h2>
          </div>
    </div>
  )
}
